...
module soc_system_mm_interconnect_1 (
		...
		output wire [19:0] shared_mem_bridge_s0_address,                  //                    shared_mem_bridge_s0.address
	...
	wire  [94:0] cmd_mux_src_data;                                                  // cmd_mux:src_data -> sysid_qsys_control_slave_agent:cp_data
	...
	wire  [20:0] shared_mem_bridge_s0_agent_m0_address;                             // shared_mem_bridge_s0_agent:m0_address -> shared_mem_bridge_s0_translator:uav_address
	...
	wire  [95:0] shared_mem_bridge_s0_agent_rf_source_data;                         // shared_mem_bridge_s0_agent:rf_source_data -> shared_mem_bridge_s0_agent_rsp_fifo:in_data
	...
	wire  [95:0] shared_mem_bridge_s0_agent_rsp_fifo_out_data;                      // shared_mem_bridge_s0_agent_rsp_fifo:out_data -> shared_mem_bridge_s0_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_001_src_data;                                              // cmd_mux_001:src_data -> shared_mem_bridge_s0_agent:cp_data
	...
	wire  [94:0] cmd_mux_002_src_data;                                              // cmd_mux_002:src_data -> led_pio_s1_agent:cp_data
	...
	wire  [95:0] dipsw_pio_s1_agent_rf_source_data;                                 // dipsw_pio_s1_agent:rf_source_data -> dipsw_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] dipsw_pio_s1_agent_rsp_fifo_out_data;                              // dipsw_pio_s1_agent_rsp_fifo:out_data -> dipsw_pio_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_003_src_data;                                              // cmd_mux_003:src_data -> dipsw_pio_s1_agent:cp_data
	...
	wire  [94:0] cmd_mux_004_src_data;                                              // cmd_mux_004:src_data -> button_pio_s1_agent:cp_data
	...
	wire  [20:0] nios2_resetreq_pio_s1_agent_m0_address;                            // nios2_resetreq_pio_s1_agent:m0_address -> nios2_resetreq_pio_s1_translator:uav_address
	...
	wire  [95:0] nios2_resetreq_pio_s1_agent_rf_source_data;                        // nios2_resetreq_pio_s1_agent:rf_source_data -> nios2_resetreq_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] nios2_resetreq_pio_s1_agent_rsp_fifo_out_data;                     // nios2_resetreq_pio_s1_agent_rsp_fifo:out_data -> nios2_resetreq_pio_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_005_src_data;                                              // cmd_mux_005:src_data -> nios2_resetreq_pio_s1_agent:cp_data
	...
	wire  [20:0] nios2_resettaken_pio_s1_agent_m0_address;                          // nios2_resettaken_pio_s1_agent:m0_address -> nios2_resettaken_pio_s1_translator:uav_address
	...
	wire  [95:0] nios2_resettaken_pio_s1_agent_rf_source_data;                      // nios2_resettaken_pio_s1_agent:rf_source_data -> nios2_resettaken_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] nios2_resettaken_pio_s1_agent_rsp_fifo_out_data;                   // nios2_resettaken_pio_s1_agent_rsp_fifo:out_data -> nios2_resettaken_pio_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_006_src_data;                                              // cmd_mux_006:src_data -> nios2_resettaken_pio_s1_agent:cp_data
	...
	wire  [94:0] mm_bridge_0_m0_agent_cp_data;                                      // mm_bridge_0_m0_agent:cp_data -> router:sink_data
	...
	wire  [94:0] sysid_qsys_control_slave_agent_rp_data;                            // sysid_qsys_control_slave_agent:rp_data -> router_001:sink_data
	...
	wire  [94:0] router_001_src_data;                                               // router_001:src_data -> rsp_demux:sink_data
	...
	wire  [94:0] shared_mem_bridge_s0_agent_rp_data;                                // shared_mem_bridge_s0_agent:rp_data -> router_002:sink_data
	...
	wire  [94:0] router_002_src_data;                                               // router_002:src_data -> rsp_demux_001:sink_data
	...
	wire  [94:0] led_pio_s1_agent_rp_data;                                          // led_pio_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [94:0] router_003_src_data;                                               // router_003:src_data -> rsp_demux_002:sink_data
	...
	wire  [94:0] dipsw_pio_s1_agent_rp_data;                                        // dipsw_pio_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [94:0] router_004_src_data;                                               // router_004:src_data -> rsp_demux_003:sink_data
	...
	wire  [94:0] button_pio_s1_agent_rp_data;                                       // button_pio_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [94:0] router_005_src_data;                                               // router_005:src_data -> rsp_demux_004:sink_data
	...
	wire  [94:0] nios2_resetreq_pio_s1_agent_rp_data;                               // nios2_resetreq_pio_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [94:0] router_006_src_data;                                               // router_006:src_data -> rsp_demux_005:sink_data
	...
	wire  [94:0] nios2_resettaken_pio_s1_agent_rp_data;                             // nios2_resettaken_pio_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [94:0] router_007_src_data;                                               // router_007:src_data -> rsp_demux_006:sink_data
	...
	wire  [94:0] router_src_data;                                                   // router:src_data -> mm_bridge_0_m0_limiter:cmd_sink_data
	...
	wire  [94:0] mm_bridge_0_m0_limiter_cmd_src_data;                               // mm_bridge_0_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [94:0] rsp_mux_src_data;                                                  // rsp_mux:src_data -> mm_bridge_0_m0_limiter:rsp_sink_data
	...
	wire  [94:0] mm_bridge_0_m0_limiter_rsp_src_data;                               // mm_bridge_0_m0_limiter:rsp_src_data -> mm_bridge_0_m0_agent:rp_data
