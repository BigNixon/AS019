...
class RfsSensor(SensorController):
    def __init__(self,name='rfsSensors', real=False, offset=0x0) -> None:
        ...
        self.modules = {
            ...
            'cn0395' : SensorController('cn0395',real, offset+0x4*4),
        }
        ...
        self.modules['cn0395'].modules={
            'gas'           : Sensor('gas',             'float', real,        offset+0x4*14),
        }
        ...
        if(real) :
            logger.debug(" \n\
                ...
                .format(
                    ...
                    hex(self.modules.get('cn0395').modules.get('gas').offset),
                )
            )