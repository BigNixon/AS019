...
class TestThresholdController(unittest.TestCase):
    ...
    def test_0_get_module_value(self):
        def loop_module(module:ThresholdController) :
            for module_key in ('Test', 'X', 'Y', 'Z', 'lux', 'humidity', 'temperature','ax', 'ay', 'az', 'gx', 'gy', 'gz', 'mx', 'my', 'mz','gas') :
    ...
    def test_2_update_component_property(self) :
        ...
        expected = {
            'thresholdProperty': {
                ...
                'gas': {'ac': 200, 'ad': 'Successfully executed patch', 'av': 2, 'value': {'min': -10, 'max': 10}},
                'settemp': {'ac': 200, 'ad': 'Successfully executed patch', 'av': 2, 'value': {'min': -10, 'max': 10}},
                '__t': 'c'
            }
        }
